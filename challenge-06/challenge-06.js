...
desafio.
*/
var teams = ['São Paulo', 'Santos', 'Mogi Miriam', 'Palmeiras', 'Mirassol'];
...
*/
showTeamPosition(1)//'O time que está em 1 lugar é o São Paulo.'
showTeamPosition(2)//'O time que está em 2 lugar é o Santos.'
showTeamPosition(3)//'O time que está em 3 lugar é o Mogi Miriam.'
...
convertToHex('Verde')//'O hexadecimal para a cor Verde é 008F39.'

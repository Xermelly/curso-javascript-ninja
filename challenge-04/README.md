...
*/
var carro = {marca:'Chevrolet', modelo:'Cobalt', placa:'FMC6969', ano: 2012, cor:'Preto', quantasPortas: 4, assentos: 5, quantidadePessoas: 0}
...
carro.addPessoas = function(x){
		var soma = carro.quantidadePessoas + x;
		var sobra = carro.assentos - carro.quantidadePessoas;
		var pessoa = sobra === 1 ? "pessoa" : "pessoas";
	if ( carro.quantidadePessoas === carro.assentos && soma >= carro.assentos  ) {
...
carro.obterMarcaModelo() // 'Este carro é um Chevrolet Cobalt'

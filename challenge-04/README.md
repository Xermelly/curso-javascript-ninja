...
*/
var carro = {marca: 'Chevrolet', modelo: 'Cobalt', placa: 'FJY4505', ano: 2012, cor: 'Preto', quantasPortas: '4', assentos: 5, quantidadePessoas: 0};
...
carro.addPessoas = function(x){
    ...
    var assDisp = carro.assentos - carro.quantidadePessoas;
    var plural = assDisp === 1 ? 'pessoa' : 'pessoas';
    ...
    if(total >  carro.assentos){
        return 'Só cabem mais '+assDisp+' '+plural+'!';
    }

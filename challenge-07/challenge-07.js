...
*/
var arr = [ 1, 'Christopher', true, {}, function(){} ];
...
*/
console.log( addItem( [ {bola:'Azul'}, 2, false ] ) );
...
*/
console.log('Numeros pares entre 100 e 120:')
for(var counter = 100; counter <= 120; counter++) {
	counter % 2 === 0 ? console.log(counter) : '';
}


console.log( 'Numeros impares entre 111 e 125:' );

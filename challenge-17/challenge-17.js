(function(){
    ...
    */
    ...
    let replaceName = text.replace(/Manuel Marques de Sousa/g, 'Christopher Santos');
    ...
    */
    ...
    let replaceNacionalidade = replaceName.replace(/brasileiro/g, 'paulista');
    console.log(replaceNacionalidade);
    ...
    */
    ...
    let replaceNum = replaceNacionalidade.replace(/\d/g, '-');
    ...
    */
    ...
    let replaceDh = replaceNacionalidade.replace(/[D-Hd-h]/g, 0);
    console.log(replaceDh);
    ...
    */
    ...
    let replaceAa = replaceNacionalidade.replace(/a/gi, 4);
    console.log(replaceAa);
    ...
    */
    ...
    let replaceUpper = replaceNacionalidade.replace(/O Centauro de Luvas/g, function(cap){
    ...
    */
    ...
    console.log('O mes de março é representado pelo numero',getMonthNumber('março'));
    console.log('O mes de setembro é representado pelo numero',getMonthNumber('setembro'));
    console.log('O mes de dezembro é representado pelo numero',getMonthNumber('dezembro'));
